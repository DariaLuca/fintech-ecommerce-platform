                ...
                <div className="space-y-8">
                    ...
                    <div>
                        <div className="flex justify-between items-end mb-4">
                            ...
                            <div className="text-2xl font-bold text-blue-600">
                                {new Intl.NumberFormat('ro-RO').format(amount)} <span className="text-lg text-gray-500 font-medium tracking-normal">EUR</span>
                            </div>
                        </div>
                        <input
                            type="range"
                    ...
                    <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 flex flex-col items-center justify-center text-center">
                        ...
                        <p className="text-3xl font-bold text-gray-900 border-b-2 border-blue-600 inline-block pb-1">
                            {new Intl.NumberFormat('ro-RO', { style: 'currency', currency: 'EUR' }).format(monthlyPayment)}
                        </p>
